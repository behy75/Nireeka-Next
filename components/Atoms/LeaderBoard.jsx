    ...
    <div className="flex space-x-3 h-12">
      ...
      <div className="flex justify-start items-center min-w-0 w-3/5">
        <div className="focus:outline-none">
          <a>
            <p className={`text-sm font-light ${nameTextColor} font-dosis`}>
              {name}
            </p>
          </a>
          <div>
            <div className="flex justify-center items-center">
              <p
                className={`text-sm font-light font-dosis ${bikeTextColor} truncate`}
              >
                {bikeName}
              </p>
              <p
      ...
      <div className="flex justify-center items-center min-w-0 w-1/5">
        <div className="focus:outline-none">
          <p className={`text-sm font-light ${pointTextColor} font-dosis`}>
            {point} points
          </p>
        </div>
      </div>
    ...
    <div className={`${backgroundColor}`}>
      <div className="py-3 md-10 md:mt-6">
        <div className="flex justify-between">
          <div>
            <h1 className={`text-xl font-light ${titleTextColor} text-white`}>
              Leaderboard
            </h1>
          </div>
                ...
                {leaderBoardData.map((item, index) => (
                  ...
                  >
                    <People
                      ...
                      bikeTextColor={bikeTextColor}
                      pointTextColor={pointTextColor}
                    />
                  </li>
                ))}
              </div>
