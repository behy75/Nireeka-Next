export const PRIVACYPOLICY = {
  ...
  links: [
    {
      title_href: "1. WHAT INFORMATION DO WE COLLECT?",
      href: "#one",
      id: "1",
    },
    {
      title_href: "2. HOW DO WE USE YOUR INFORMATION?",
      href: "#two",
      id: "2",
    },
    {
      title_href: "3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?",
      href: "#three",
      id: "3",
    },
    {
      title_href: "4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?",
      href: "#four",
      id: "4",
    },
    {
      title_href: "5. HOW LONG DO WE KEEP YOUR INFORMATION?",
      href: "#five",
      id: "5",
    },
    {
      title_href: "6. HOW DO WE KEEP YOUR INFORMATION SAFE?",
      href: "#six",
      id: "6",
    },
    {
      title_href: "7. WHAT ARE YOUR PRIVACY RIGHTS?",
      href: "#seven",
      id: "7",
    },
    {
      title_href: "8. CONTROLS FOR DO-NOT-TRACK FEATURES",
      href: "#eight",
      id: "8",
    },
    {
      title_href: "9. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?",
      href: "#nine",
      id: "9",
    },
    {
      title_href: "10. DO WE MAKE UPDATES TO THIS POLICY?",
      href: "#ten",
      id: "10",
    },
    {
      title_href: "11. HOW CAN YOU CONTACT US ABOUT THIS POLICY?",
      href: "#eleven",
      id: "11",
    },
  ],
  WHAT_INFORMATION: [
    {
      ...
      describ: "The Personal information you disclose to us",
      head: "In Short:",
      title_1:
      ...
      T_Head_8: "Information automatically collected",
      head_8: "In Short:",
      title_8:
      ...
      T_Head_9: "Information collected through our Apps",
      head_9: "In Short: ",
      title_9:
        "We may collect information regarding your geo-location, mobile device, push notifications when you use our apps. If you use our Apps, we may also collect the following information:",
      paragraph_9_1:
        "- Geo-Location Information. We may request access or permission to and track location-based information from your mobile device, either continuously or while you are using our mobile application, to provide location-based services. If you wish to change our access or permissions, you may do so in your device's settings.",
      paragraph_9_2:
        "- Mobile Device Access. We may request access or permission to certain features from your mobile device, including your mobile device's Bluetooth, sensors, SMS messages, storage, and other features. If you wish to change our access or permissions, you may do so in your device's settings.",
      paragraph_9_3:
      ...
      T_Head_10: "Information collected from other sources",
      head_10: "In Short: ",
      title_10:
  ...
  HOW_DO_WE_USE_YOUR_INFORMATION: [
    {
      id: "two",
      name: "2. HOW DO WE USE YOUR INFORMATION?",
      head: "In Short: ",
      title_1:
      ...
      title_3: "We use the information we collect or receive: ",
      title_4:
  ...
  WILL_YOUR_INFORMATION: [
    {
      id: "three",
      name: "3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?",
      head: "In Short: ",
      title_1:
      ...
      title_5:
        "- Performance of a Contract: Where we have entered into a contract with you, we may processes your personal information to fulfill the terms of our contract.",
      title_6:
  ...
  HOW_LONG_DO_WE_KEEP: [
    {
      id: "five",
      name: "5. HOW LONG DO WE KEEP YOUR INFORMATION?",
      head: "In Short: ",
      title_1:
  ...
  INFORMATION_SAFE: [
    {
      id: "six",
      name: "6. HOW DO WE KEEP YOUR INFORMATION SAFE?",
      head: "In Short: ",
      title_1:
  ...
  PRIVACY_RIGHTS: [
    {
      id: "seven",
      name: "7. WHAT ARE YOUR PRIVACY RIGHTS?",
      head: "In Short: ",
      title_1:
      ...
      href: "http://ec.europa.eu/justice/data-protection/bodies/authorities/index en.htm",
      name_2: "Account Information",
      title_5:
        "If you would at any time like to review or change the information in your account or terminate your account, you can:",
      title_6: "- Contact us using the contact information provided.",
      title_7: "- Log into your account settings and update your user account.",
      title_8:
        "Upon your request to terminate your account, we will deactivate or delete your account and information from our active databases. However, some information may be retained in our files to prevent fraud, troubleshoot problems, assist with any investigations, enforce our Terms of Use, and/or comply with legal requirements.",
      title_9:
        "Cookies and similar technologies: Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Sites or Apps. To opt-out of interest-based advertising by advertisers on our Sites or Apps visit ",

      href_2: "http://www.aboutads.info/choices/.",
      title_10:
        "Opting out of email marketing: You can unsubscribe from our marketing email list at any time by clicking on the unsubscribe link in the emails that we send or by contacting us using the details provided below. You will then be removed from the marketing email list — however, we will still need to send you service-related emails that are necessary for the administration and use of your account. To otherwise opt-out, you may:",

      title_11: "- Contact us using the contact information provided.",
    },
  ],
  CONTROLS_FOR: [
    {
      id: "eight",
      name: "8. CONTROLS FOR DO-NOT-TRACK FEATURES",
      title_1:
  ...
  DO_CALIFORNIA: [
    {
      id: "nine",
      name: "9. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?",
      head: "In Short: ",
      title_1:
      ...
      title_3:
        "If you are under 18 years of age, reside in California, and have a registered account with the Sites or Apps, you have the right to request the removal of unwanted data that you publicly post on the Sites or Apps. To request the removal of such data, please contact us using the contact information provided below, and include the email address associated with your account and a statement that you reside in California. We will make sure the data is not publicly displayed on the Sites or Apps, but please be aware that the data may not be completely or comprehensively removed from our systems.",
    },
  ],
  DO_WE_MAKE_UPDATE: [
    {
      id: "ten",
      name: "10. DO WE MAKE UPDATES TO THIS POLICY?",
      head: "In Short: ",
      title_1:
  ...
  HOW_CAN_YOU_CONTACT: [
    {
      id: "eleven",
      name: "11. HOW CAN YOU CONTACT US ABOUT THIS POLICY?",
      title_1:
        "If you have questions or comments about this policy, you may email us at support@nireeka.com.",
    },
  ],
};
