...
import { delAddressPending } from "../../../app/userPanelSlice";
import LoadingNireeka from "../../Atoms/LoadingNireeka";
import MainModal from "../../Atoms/MainModal";

export default function DelAddressModal({ open, setOpen }) {
  const state = useSelector((state) => state);
  const dispatch = useDispatch();
  let { getEditAddressData, delAddressReqSuccess } = state.userPanel;
          ...
          <div className="">
            ...
            <div className="mt-3 mx-3 text-justify sm:ml-4">
              <p className="text-sm text-gray-500">
                Are you sure you want to delete your address? All your data for
                this address will always be deleted from our servers. This
          ...
          <div className="mt-4 flex flex-row-reverse">
            {getEditAddressData ? (
              <div
                ...
                onClick={() => {
                  // setOpen(false);
                  dispatch(delAddressPending(getEditAddressData.id));
                }}
              >
